...
```
Fase 1 (Fundação) → Fase A.1 (Benchmark Infra) → Fase B (Upload/Parsing) → Fase A.2 (Batalha de Modelos) → Fase 2 (Pipeline) → Fase 3 → Fase 4 → Fase 5
```

**Plano detalhado de cada fase:**
- [docs/fase1.md](docs/fase1.md) — Fundação: servidores, Supabase, ontologia
- [docs/fase_ai_benchmark.md](docs/fase_ai_benchmark.md) — Benchmark: Infraestrutura e CLI teste
- [docs/fase_parsing.md](docs/fase_parsing.md) — Transcrição Whisper, testes e validação
- [docs/fase_benchmark_visual.md](docs/fase_benchmark_visual.md) — Benchmark: Batalha Lado-a-Lado de Modelos
...
| `docs/fase_ai_benchmark.md` | ✅ Existe | Plano Fase A.1 com infraestrutura de testes |
| `docs/fase_parsing.md` | ✅ Existe | Plano Fase B com transcrever e suite de testes |
| `docs/fase_benchmark_visual.md` | ⚠️ Parcial | **Pausado:** Plano Fase A.2 com batalha visual |
...
| `public/benchmark_visual.html` | ❌ Pendente | Batalha de modelos lado-a-lado |
...
| `api/routers/benchmark.py` | ❌ Pendente | Fase A.2 |
| `api/benchmark/runner.py` | ❌ Pendente | Fase A.1 |
| `api/benchmark/report.py` | ❌ Pendente | Fase A.1 |
| `api/benchmark/prompts/` (7 arquivos) | ❌ Pendente | Fase A.1 |
