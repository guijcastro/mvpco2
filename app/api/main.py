...
# ─── Routers ─────────────────────────────────────────────────────────────────
# Fase 1 e Fase A.2: settings (API keys) e Batalha Lado-a-Lado
...
async def status():
    return {
        "phase": "Fase A.2 — Batalha Visual",
        "message": "API operacional. Settings ativo. Benchmark em Batalha Ativo.",
        "docs": "/docs",
    }
